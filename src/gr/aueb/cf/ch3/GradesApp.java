 ...
 *
 * θα υπολογιζει τον μέσο όρο και θα χαρζξτηρίζει
 * "Αριστα" αν ο μέσος όρος είνα >=9, "πολ΄θ καλά" αν ειναι>=7
 * καλώς αν ειναι >=5 αν ο μεσο ορος είνα <5 'Αποτυχία
 *
 */
public class GradesApp {
    public static void main(String[] args) {
        ...
        if (totalMarks <= 0) {
            System.out.println("Total marks not be zero.");
            System.exit(1);
